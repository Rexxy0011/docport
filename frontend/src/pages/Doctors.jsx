  ...
  return (
    <div>
      <p className="text-gray-600">
        Find the right specialist to meet your healthcare needs.
      </p>
      <div className="flex flex-col sm:flex-row items-start gap-5 mt-5">
        ...
        >
          ...
          <p
            ...
            className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === " Dermatologists" ? "bg-indigo-100 text-black" : ""}`}
          >
            Dermatologists
          </p>
